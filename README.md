 ...
 **Финансист.**     
1.  Финансист на основе анализа документов (кредитной истории клиента, анализе доходов, а также необязательные документы: рейтинг клиента и документ о причине реструктуризации) принимает решение об одобрении или отказе заявления клиента.    
2. При одобрении финансист выбирает кредитный план для клиента.    
3. Финансист на основе рейтинга и кредитного плана клиента генерирует специальные предложения кредитования.      
  
 **Менеджер**.    
1. Менеджер принимает заявки от клиента.   
2. Менеджер оглашает клиентам решения финансиста.   
...
[Диаграмма классов] (https://github.com/Nikitina-Ann/design/blob/master/ClassDiagram.PNG)
